...
<body>
        ...
        <table>
            ...
            if (mysqli_num_rows($res) == 0) { // Check if there are no search results
                ...
                while ($row = mysqli_fetch_assoc($res)) { // Iterate through search results
                    ...
                    echo "<td>" . $row['Developer'] . "</td>"; // Display the game developer
                    echo "<td>" . $row['Publisher'] . "</td>"; // Display the game publisher
                    echo "<td>" . $row['Release_date'] . "</td>"; // Display the game release date
    ...
    <div style="text-align: center;">
        ...
        <div class="container" style="text-align: center;">
            <a href="index.php">Back to Game List</a> <!-- Display a link to go back to the main game list -->
        </div>
    </div>
